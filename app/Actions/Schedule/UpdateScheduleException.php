...
final class UpdateScheduleException
{
    ...
    public function __invoke(UpdateScheduleExceptionData $data): ScheduleException
    {
        ...
        $previousCentreId = $exception->centre_id;
        ...
        $this->invalidateCaches($exception, $wasGlobal, $previousCentreId);
    ...
    private function invalidateCaches(
        ...
        if ($previousCentreId !== null && $previousCentreId !== $exception->centre_id) {
            Cache::forget(CacheKeys::scheduleCentre($previousCentreId));
        }
    }
}
