...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement(
            'ALTER TABLE centre_weekly_hours ADD CONSTRAINT chk_cwh_open_times '
            .'CHECK ((is_open = 0) OR (opens_at IS NOT NULL AND closes_at IS NOT NULL AND opens_at < closes_at))',
        );
    }
